...
function App() {
  ...
  // Fix for corrupted Java sessionStorage
  useEffect(() => {
  ...
  // Handle Theme Shifts for Terminal
  useEffect(() => {
    if (xterm.current) {
  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .stylish-c-1 { font-family: "Playfair Display", serif !important; font-style: italic !important; font-weight: 900 !important; font-size: 1.2em !important; margin-right: -1px !important; color: ${theme === 'light' ? '#000000' : colors.accent} !important; }
        .stylish-c-2 { font-family: "Georgia", serif !important; font-style: italic !important; font-weight: 900 !important; font-size: 1.1em !important; margin-right: -1px !important; color: ${theme === 'light' ? '#000000' : colors.accent} !important; }
      ...
      <Header
        ...
        runCode={runCode} isRunning={isRunning} isInitializing={isInitializing}
        setIsAboutOpen={setIsAboutOpen} colors={colors}
        setCode={setCode} xterm={xterm} setOutputTab={setOutputTab}
      />

      <div style={{ display: 'flex', flex: 1, minHeight: 0, padding: '15px', gap: '15px' }}>
        <EditorContainer
          language={language} theme={theme}
          code={code} setCode={setCode} colors={colors}
        />

        <OutputContainer
          theme={theme} colors={colors}
          outputTab={outputTab} setOutputTab={setOutputTab}
          plotImage={plotImage} terminalRef={terminalRef}
